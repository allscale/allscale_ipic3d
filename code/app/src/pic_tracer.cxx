...
public:
	...
	void increment(int t, const utils::Coordinate<3>& pos, int num = 1) {
		increment(t,(int)pos.x,(int)pos.y,(int)pos.z,num);
	}
...
private:
	...
	std::uint64_t flatten(int t, int x, int y, int z) const {
...
//				R1, R2, // within the universe
	...
	// save result
	{
		...
		for(int t=0; t<num_frames; t++) {
			...
			// generate file name
			char fileName[50];
			std::sprintf(fileName,"result_%" PRId64 ".csv.%06d", timeStamp,t);
