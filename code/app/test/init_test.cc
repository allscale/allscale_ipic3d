...
namespace ipic3d {
	...
	TEST(InitProperties, Basic) {
		...
		EXPECT_EQ((Vd{0.0,0.0,0.0}), properties.externalMagneticField);
		EXPECT_EQ(1.0, properties.rhoInit);
		

		InitProperties init(100, {10,20,30}, {0.2,0.3,0.4}, {1.3,1.6,0.0001}, {0.0,2.0,3.6}, 1.23456);
		...
		EXPECT_EQ((Vd{0.0,2.0,3.6}), init.externalMagneticField);
