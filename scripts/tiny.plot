...
set logscale xy
set xtics (1, 2, 4, 8)
set output "| epstopdf --filter > ../imgs/170607_tiny_strong_scaling.pdf"
...
plot "../results/170607_tiny_strong_scaling.txt" using 1:(($3)/($1)) with linespoints lw 3.0 lc 3 ps 2.0 pt 3 title "Ideal scaling" , \
