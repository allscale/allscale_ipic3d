...
#SBATCH -e allscale_ipic3d_512K_8nodes.e
#SBATCH -o allscale_ipic3d_512K_8nodes.o
...
do
	...
	do
		...
		aprun -n 8 -N 1 $APP --hpx:threads=32 -Ihpx.stacks.use_guard_pages=0 $HOME/inputs/shared_16c.inp
