...
#SBTACH -q work
#SBATCH -t 02:00:00
#SBATCH -J allscalecc_ipic3d_weak_16000000
...
BASE_PARTICLES=16000000
PARTICLES=$((BASE_PARTICLES * SLURM_NNODES))

echo "Running on $i cores, with $BASE_PARTICLES * $SLURM_NNODES = $PARTICLES particles"
srun $APP --hpx:threads=20 :U:$PARTICLES -Ihpx.stacks.use_guard_pages=0 --hpx:print-counter='/agas{locality#*/total}/count/increment_credit'
