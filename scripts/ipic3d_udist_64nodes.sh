...
#SBATCH -e 180924_allscale_ipic3d_udist_64nodes.e
#SBATCH -o 180924_allscale_ipic3d_udist_64nodes.o
...
do
	...
	do
		...
		do
			...
			aprun -n 64 -N 1 -d 32 $APP :U:$PARTICLES --hpx:threads=32 -Ihpx.stacks.use_guard_pages=0
		done
