...
#SBATCH -e allscale_ipic3d_512K_32nodes.e
#SBATCH -o allscale_ipic3d_512K_32nodes.o
...
do
	...
	do
		...
		aprun -n 32 -N 1 $APP --hpx:threads=32 -Ihpx.stacks.use_guard_pages=0 $HOME/inputs/32nodes.inp
