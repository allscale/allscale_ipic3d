...
#SBATCH -e 180924_allscale_ipic3d_512K_2nodes.e
#SBATCH -o 180924_allscale_ipic3d_512K_2nodes.o
...
do
	...
	do
		...
		aprun -n 2 -N 1 $APP --hpx:threads=32 -Ihpx.stacks.use_guard_pages=0 $HOME/inputs/shared_4c.inp
