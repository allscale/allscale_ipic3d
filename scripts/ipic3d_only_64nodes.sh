...
#SBATCH -e allscale_ipic3d_512K_64nodes.e
#SBATCH -o allscale_ipic3d_512K_64nodes.o
...
do
	...
	do
		...
		aprun -n 64 -N 1 $APP --hpx:threads=32 -Ihpx.stacks.use_guard_pages=0 $HOME/inputs/64nodes.inp
