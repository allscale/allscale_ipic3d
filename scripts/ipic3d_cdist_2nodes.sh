...
#SBATCH -e allscale_ipic3d_cdist_2nodes.e
#SBATCH -o allscale_ipic3d_cdist_2nodes.o
...
do
	...
	do
		...
		do
			...
			aprun -n 2 -N 1 $APP :C:$PARTICLES --hpx:threads=32 -Ihpx.stacks.use_guard_pages=0
		done
