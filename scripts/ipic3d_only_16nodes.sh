...
#SBATCH -e allscale_ipic3d_512K_16nodes.e
#SBATCH -o allscale_ipic3d_512K_16nodes.o
...
do
	...
	do
		...
		aprun -n 16 -N 1 $APP --hpx:threads=32 -Ihpx.stacks.use_guard_pages=0 $HOME/inputs/16nodes.inp
