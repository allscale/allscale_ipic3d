...
#SBATCH -e 180924_allscale_ipic3d_udist_8nodes.e
#SBATCH -o 180924_allscale_ipic3d_udist_8nodes.o
...
do
	...
	do
		...
		do
			...
			aprun -n 8 -N 1 -d 32 $APP :U:$PARTICLES --hpx:threads=32 -Ihpx.stacks.use_guard_pages=0
		done
